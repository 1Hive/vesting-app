...
var BLOCK_EXPLORERS = {
  ...
  blockscout: function blockscout(_ref2) {
    ...
    var networkName = BLOCKSCOUT_NETWORK_TYPES.get(networkType);
    var typePart = BLOCKSCOUT_TYPES.get(type);
  ...
  polygonscan: function polygonscan(_ref3) {
    ...
    var subdomain = POLYGONSCAN_NETWORK_TYPES.get(networkType);
    var typePart = POLYGONSCAN_TYPES.get(type);
  ...
  arbiscan: function arbiscan(_ref4) {
    ...
    var subdomain = ARBISCAN_NETWORK_TYPES.get(networkType);
    var typePart = ARBISCAN_TYPES.get(type);
