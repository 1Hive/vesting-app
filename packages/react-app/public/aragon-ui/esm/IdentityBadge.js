...
var IdentityBadge = React.memo(function IdentityBadge(_ref) {
  var badgeOnly = _ref.badgeOnly,
      ...
      props = _objectWithoutProperties(_ref, ["badgeOnly", "compact", "connectedAccount", "entity", "explorerProvider", "label", "labelStyle", "networkType", "popoverAction", "popoverTitle", "shorten", "customLabel", "fontSize"]);
