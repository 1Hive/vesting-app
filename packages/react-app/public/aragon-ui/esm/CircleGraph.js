...
import 'react-dom';
import { r as renderprops_7, a as renderprops_1 } from './renderprops-81576a3f.js';
...
var _StyledAnimatedCircle = _styled(renderprops_7.circle).withConfig({
...
function CircleGraph(_ref) {
  ...
  return /*#__PURE__*/React.createElement(renderprops_1, {
    to: {
      progressValue: value
    },
    native: true
    ...
    })), /*#__PURE__*/React.createElement(_StyledDiv2, null, typeof label !== 'function' ? label : label && /*#__PURE__*/React.createElement(_StyledDiv3, null, /*#__PURE__*/React.createElement(_StyledDiv4, null, /*#__PURE__*/React.createElement(renderprops_7.div, {
      style: {
        fontSize: "".concat(size * 0.2, "px")
      }
    }, progressValue.interpolate(labelPart('prefix'))), /*#__PURE__*/React.createElement(renderprops_7.div, {
      style: {
