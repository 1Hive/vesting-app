...
function CustomInput(props) {
  ...
  if (props.type === 'checkbox') {
    delete props.type;
    return /*#__PURE__*/React__default.createElement(Checkbox.default, props);
  }
...
function Markdown$1(_ref) {
  var allowHtml = _ref.allowHtml,
      ...
      style = _ref.style,
      props = objectWithoutProperties._objectWithoutProperties(_ref, ["allowHtml", "className", "content", "markdownToJsxOptions", "normalized", "style"]);
  ...
  var markdown = /*#__PURE__*/React__default.createElement("div", {
    className: className,
    style: style
  ...
  return normalized ? /*#__PURE__*/React__default.createElement(NormalizedHtml.default, null, markdown) : markdown;
}

Markdown$1.propTypes = {
