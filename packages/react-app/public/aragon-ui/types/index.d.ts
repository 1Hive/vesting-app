...
export declare function AppView({ appBar, children, height, padding, tabs, title, ...props }: {
    [x: string]: any;
    appBar: any;
    children: any;
    height: any;
...
export declare function BackButton({ label, ...props }: {
    [x: string]: any;
    label: any;
}): JSX.Element;
...
export declare function Badge({ background, foreground, shape, children, ...props }: {
    [x: string]: any;
    background: any;
    foreground: any;
    shape: any;
...
export declare function BadgeNumber({ background, children, foreground, label, shape, small, ...props }: {
    [x: string]: any;
    background: any;
    children: any;
    foreground: any;
...
export declare function Bar({ children, primary, secondary, ...props }: {
    [x: string]: any;
    children: any;
    primary: any;
    secondary: any;
 ...
 */
export declare function blockExplorerUrl(type: string, value: string, { networkType, provider }?: {
    networkType: string;
    provider: string;
}): string;

export declare function Box({ heading, children, padding, ...props }: {
    [x: string]: any;
    heading?: any;
    children?: any;
    padding?: any;
...
export declare function ButtonIcon({ label, children, mode, ...props }: {
    [x: string]: any;
    label: any;
    children: any;
    mode: any;
...
export declare function ButtonText({ horizontalPadding, ...props }: {
    [x: string]: any;
...
export declare function Card({ children, width, height, onClick, ...props }: {
    [x: string]: any;
    children: any;
    width: any;
    height: any;
...
export declare function CardLayout({ children, columnWidthMin, rowHeight, ...props }: {
    [x: string]: any;
    children: any;
    columnWidthMin: any;
    rowHeight: any;
...
export declare function CircleGraph({ color, label, size, strokeWidth, value }: {
    color: any;
    label: any;
    size: any;
    strokeWidth: any;
...
export declare function ContextMenu({ children, zIndex, disabled }: {
    children: any;
    zIndex: any;
    disabled: any;
}): JSX.Element;
...
export declare function DateRangePicker({ format, endDate: endDateProp, onChange, startDate: startDateProp, }: {
    format: any;
    endDate: any;
    onChange: any;
    startDate: any;
...
export declare function Details({ children, label, onToggle, opened: openedProp, ...props }: {
    [x: string]: any;
    children: any;
    label: any;
    onToggle: any;
...
export declare function difference(date1: any, date2: any, options?: {}): {
    remaining: any;
    remainingUnits: any;
    seenNonZero: boolean;
};
...
export declare function Distribution({ colors, showLegend, heading, itemTitle, renderLegendItem: LegendItem, renderFullLegendItem: FullLegendItem, items, }: {
    colors: any;
    showLegend: any;
    heading: any;
    itemTitle: any;
...
export declare namespace Distribution {
    ...
    export namespace defaultProps {
        ...
        export function itemTitle_1({ item, percentage, index }: {
            item: any;
            percentage: any;
            index: any;
        }): string;
            { itemTitle_1 as itemTitle };
        export function renderLegendItem_1({ item, percentage, index }: {
            item: any;
            percentage: any;
            index: any;
        }): string;
 ...
 * @returns {string}
 */
export declare function divideRoundBigInt(dividend: BigInt | string | number, divisor: BigInt | string | number): string;

export declare const DropDown: any;

export declare function eachDayOfInterval({ start, end }?: {
    start: any;
    end: any;
}): any[];
...
export declare function Field({ children, label, required, ...props }: {
    [x: string]: any;
    children: any;
    label: any;
    required: any;
...
export declare function font({ size, weight, smallcaps, monospace, deprecationNotice, }: {
    size: any;
    weight: any;
    smallcaps?: boolean;
    monospace?: boolean;
 ...
 */
export declare function formatIntegerRange(value?: number, min?: number, max?: number, maxSuffix?: number): string;
 ...
 * @returns {string}
 */
export declare function formatTokenAmount(amount: BigInt | string | number, decimals: BigInt | string | number, { digits, symbol, displaySign }?: BigInt | string | number): string;

export declare function forwardProps(instance: any, names: any): any;

export declare const GU: 8;

export declare function Header({ primary, secondary, children, ...props }: {
    [x: string]: any;
    primary: any;
    secondary: any;
    children: any;
...
export declare function Help({ hint, children }: {
    hint: any;
    children: any;
}): JSX.Element;
...
declare function IconAddUser({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
declare function IconAlert({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconAlignCenter({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconAlignJustify({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconAlignLeft({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconAlignRight({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconAragon({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconArrowDown({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconArrowLeft({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconArrowRight({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconArrowUp({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconAtSign({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconBlock({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconBookmark({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconCalendar({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconCanvas({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
declare function IconCaution({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconCenter({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconChart({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconChat({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconCheck({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconChip({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconCircleCheck({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
declare function IconCircleMinus({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
declare function IconCirclePlus({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
declare function IconClock({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconCloudDownload({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconCloudUpload({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
declare function IconCoin({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconConfiguration({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconConnect({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconConnection({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconConsole({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconCopy({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
declare function IconCross({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconDashedSquare({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconDown({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconDownload({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconEdit({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconEllipsis({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconEnter({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconEthereum({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconExternal({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
declare function IconFile({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconFilter({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconFlag({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconFolder({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconGraph({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconGraph2({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
declare function IconGrid({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconGroup({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconHash({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconHeart({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconHide({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconHome({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconImage({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
declare function IconInfo({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconLabel({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconLayers({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconLeft({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconLink({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconLocation({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconLock({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconMaximize({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconMenu({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconMinimize({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconMinus({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconMove({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconNoPicture({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconPicture({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconPlus({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconPower({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconPrint({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconProhibited({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconQuestion({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconRefresh({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconRemoveUser({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconRight({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconRotateLeft({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconRotateRight({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconSearch({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconSettings({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconShare({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconSquare({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconSquareMinus({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconSquarePlus({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconStar({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconStarFilled({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconSwap({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconTarget({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconToken({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconTrash({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconUnlock({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconUp({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconUpload({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconUser({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconView({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconVote({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconWallet({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
declare function IconWarning({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconWorld({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconWrite({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconZoomIn({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function IconZoomOut({ size, ...props }: {
    [x: string]: any;
    size?: any;
}): JSX.Element;
...
export declare function ImageExists({ timeUntilFallback, src, children }: {
    timeUntilFallback: any;
    src: any;
    children: any;
}): any;

export declare function Info({ children, mode, color, titleColor, background, borderColor, title, ...props }: {
    [x: string]: any;
    children: any;
    mode: any;
    color: any;
...
export declare function Layout({ breakpoints, children, paddingBottom, parentWidth, ...props }: {
    [x: string]: any;
    breakpoints: any;
    children: any;
    paddingBottom: any;
 ...
 * @returns {Number}
 */
export declare function lerp(progress: number, value1: number, value2: number): number;

export declare function LineChart({ animDelay, borderColor, color, dotRadius, height, label, labelColor, lines: linesProps, reset, springConfig, total, width: widthProps, ...props }: {
    [x: string]: any;
    animDelay: any;
    borderColor: any;
    color: any;
...
export declare namespace LineChart {
    ...
    export namespace defaultProps {
        ...
        export function label_1(index: any): any;
            { label_1 as label };
        export function color_1(index: any, { lines }: {
            lines: any;
        }): string;
            { color_1 as color };
    }
...
export declare function Link({ onClick, href, external, ...props }: {
    [x: string]: any;
    onClick?: () => void;
    href?: any;
    external?: any;
...
export declare function Markdown({ allowHtml, className, content, markdownToJsxOptions, normalized, style, ...props }: {
    [x: string]: any;
    allowHtml: any;
    className: any;
    content: any;
...
export declare function Modal({ children, onClose, onClosed, padding, visible, width, closeButton, ...props }: {
    [x: string]: any;
    children?: any;
    onClose?: () => void;
    onClosed?: () => void;
...
export declare function observe(observe: any, initialState?: {}): (Component: any) => {
    new (): {
        state: {};
        componentDidMount(): void;
    ...
    propTypes: {
        observable: ({ observable }: {
            observable: any;
        }, _: any, componentName: any) => void;
    };
};

export declare const Pagination: any;

export declare function PartitionBar({ data, caption, colors }: {
    data: any;
    caption: any;
    colors: any;
}): JSX.Element;
...
export declare function Popover({ scaleEffect, visible, ...props }: {
    [x: string]: any;
    scaleEffect: any;
    visible: any;
}): JSX.Element;
...
export declare function RadioList({ description, items, onChange, selected, title, ...props }: {
    [x: string]: any;
    description: any;
    items: any;
    onChange: any;
...
export declare namespace RadioList {
    export namespace propTypes {
        ...
        const items: any;
        const onChange: any;
        export function selected({ items, selected }: {
            items: any;
            selected: any;
        }, _: any, componentName: any): void;
        const title: any;
...
export declare function ScrollView({ children, horizontal, vertical, ...props }: {
    [x: string]: any;
    children: any;
    horizontal: any;
    vertical: any;
 ...
 */
export declare function shortenAddress(address: string, charsLength?: number): string;
 ...
 * @returns {string} The shortened address
 */
export declare function shortenTransaction(address: string, charsLength?: number): string;

export declare function SidePanel({ blocking, children, opened, onClose, onTransitionEnd, title, }: {
    blocking: any;
    children: any;
    opened: any;
    onClose: any;
...
export declare function SidePanelSplit({ children, ...props }: {
    [x: string]: any;
    children: any;
}): JSX.Element;
...
export declare function Split({ primary, secondary, invert }: {
    primary: any;
    secondary: any;
    invert: any;
}): JSX.Element;
...
export declare function Switch({ checked, disabled, onChange }: {
    checked: any;
    disabled: any;
    onChange: any;
}): JSX.Element;
...
export declare function SyncIndicator({ children, label, shift, visible, ...props }: {
    [x: string]: any;
    children: any;
    label: any;
    shift: any;
...
export declare function Table({ header, children, noSideBorders, ...props }: {
    [x: string]: any;
    header: any;
    children: any;
    noSideBorders: any;
...
export declare function TableCell({ children, contentContainer: Container, align, ...props }: {
    [x: string]: any;
    children: any;
...
export declare function TableHeader({ title, align, ...props }: {
    [x: string]: any;
    title: any;
    align: any;
}): JSX.Element;
...
export declare function Tag({ background, children, color, limitDigits, icon, label, mode, size, uppercase, ...props }: {
    [x: string]: any;
    background: any;
    children: any;
    color: any;
...
declare function Text_2({ children, color, deprecationNotice, monospace, size, smallcaps, weight, ...props }: {
    [x: string]: any;
    children: any;
    color: any;
...
export declare function textStyle(name: any, includeLineHeight?: boolean): string;

export declare function Theme({ theme, children }: {
    theme: any;
    children: any;
}): JSX.Element;
...
export declare function useArrowKeysFocus(refs: any): {
    highlightedIndex: number;
    setHighlightedIndex: Dispatch<SetStateAction<number>>;
};

export declare function useClickOutside(cb: any, ref?: MutableRefObject<undefined>): {
    ref: MutableRefObject<undefined>;
};

export declare const useContainsAppView: () => any;

export declare function useFocusEnter(cb: any, _ref: any): {
    ref: any;
    handleFocusEnter: (event: any) => void;
};

export declare function useFocusLeave(cb: any, _ref: any): {
    ref: any;
    handleFocusLeave: (event: any) => void;
};

export declare function useImageExists(src: any, timeUntilFallback?: number): {
    src: any;
...
export declare function useOnBlur(...params: any[]): {
    ref: any;
    handleFocusLeave: (event: any) => void;
};
