...
var getPrototypeOf = require('./getPrototypeOf-236fce8e.js');
require('./color.js');
  ...
  getPrototypeOf._createClass(AppBar, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement(useInside_esm.Inside, {
        ...
        _css6: padding
      }, endContent)), /*#__PURE__*/React__default.createElement(renderprops.renderprops_3, {
        items: tabs,
        from: {
          opacity: 0,
          height: 0
...
var AppBarTitle = index$1.PublicUrl.hocWrap(_styled__default.h1.withConfig({
  ...
  return chevron ? _styled.css(["url(", ")"], index$1.PublicUrl.styledUrl(chevronSvg)) : 'none';
}, function (_ref2) {
  var clickable = _ref2.clickable;
  return clickable ? 'pointer' : 'default';
}));
var TabsWrapper = _styled__default(renderprops.renderprops_7.div).withConfig({
