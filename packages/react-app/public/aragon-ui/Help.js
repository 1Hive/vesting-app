...
})(["position:relative;max-width:", "px;min-width:", "px;padding:", "px;background:", ";&:before{content:'';position:absolute;top:0;left:0;bottom:0;width:", "px;background:", ";}"], function (p) {
  return p._css4;
}, function (p) {
  return p._css5;
}, function (p) {
...
function Help(_ref) {
  ...
  var _useInside = useInside_esm.useInside('Box:heading'),
      _useInside2 = slicedToArray._slicedToArray(_useInside, 1),
      insideBoxHeading = _useInside2[0];

  var _useInside3 = useInside_esm.useInside('Field:label'),
