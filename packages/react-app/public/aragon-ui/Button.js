...
var slicedToArray = require('./slicedToArray-80fbe817.js');
...
function modeStyles(theme, mode, disabled) {
  if (disabled) {
    return {
      ...
      border: "1px solid ".concat(theme.disabledBorder)
    };
  }
...
function Button(_ref) {
  ...
  var _useInside = useInside_esm.useInside('EmptyStateCard'),
      _useInside2 = slicedToArray._slicedToArray(_useInside, 1),
      insideEmptyStateCard = _useInside2[0];

  var _useInside3 = useInside_esm.useInside('Header:secondary'),
  ...
  }), /*#__PURE__*/React__default.createElement(useInside_esm.Inside, {
    name: "Button",
    data: insideData
  }, children || /*#__PURE__*/React__default.createElement(React__default.Fragment, null, displayIcon && /*#__PURE__*/React__default.createElement(useInside_esm.Inside, {
    name: "Button:icon",
    data: insideData
  }, /*#__PURE__*/React__default.createElement(_StyledSpan, {
    _css13: iconColor,
    _css14: middleSpace
  }, icon)), displayLabel && /*#__PURE__*/React__default.createElement(useInside_esm.Inside, {
    name: "Button:label",
    data: insideData
  }, label))));
}
